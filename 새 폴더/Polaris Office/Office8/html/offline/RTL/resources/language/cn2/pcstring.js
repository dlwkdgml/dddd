var LanguagePack = new function() {
	...
	this.KEYWORD_RECENT = '最近使用的文档';
	this.KEYWORD_LASTMODIFIED = '上次修改时间';
	this.KEYWORD_NOSEARCHRESULT = '没有查找结果。';
	this.KEYWORD_CLOSE = '关闭';
	this.KEYWORD_FOLDER = '文件夹';
	this.KEYWORD_SUPPORT = '用户咨询';
	this.KEYWORD_DELETE = '删除';
	this.KEYWORD_CONFIRM = '确认';
	...
	this.ALL = '全部';
	this.OPEN = '打开';
	this.LOCALFILE_DELETE = '文件将只从“最近使用文档”中删除。';
	this.LOCALFILE_UPLOAD_FALIL_MSG1 = '此路径下不存在该文档。';
	this.LOCALFILE_UPLOAD_FALIL_MSG2 = '要从“最近使用文档”中删除吗？';
	this.NOT_CREATE_BASIC_NEWDOCUMENT_MSG = '因为已超过免费使用量，所以无法新建文档。升级账户以创建和编辑新文档。';
	this.NOT_CREATE_SMART_NEWDOCUMENT_MSG = function() {
		return '您的月使用量已用完，无法再使用。您的月使用量将于{0}天后重置。未来将提供专业升级功能。'.format(arguments);
	};
	...
	this.SEARCH_RESULT = function(){ return "'{0}' 查找结果 <em>{1}</em>件".format(arguments);};
	...
	this.OFFLINE_COMPUTER_MSG =  function(){
		...
		if(arguments[0] == 6 || arguments[0] == 7 || arguments[0] == 11) {
			...
			str = "由于未连接到网络，无法导入云空间文档。要打开您电脑上的文档吗？";
		}
		return str.format(arguments);
	};
